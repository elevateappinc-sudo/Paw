      ...
      <div style={{ padding: "32px 20px 20px", display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          {business.description && (
            <p style={{ margin: "4px 0 0", fontSize: 14, color: "rgba(235,235,245,0.5)" }}>
              {business.description}
            </p>
          )}
        </div>
      ...
      {editing && (
        <Card style={{ margin: "0 20px 12px" }}>
          <div style={{ padding: 16 }}>
            <label style={{ fontSize: 12, color: "rgba(235,235,245,0.5)", textTransform: "uppercase", letterSpacing: 1 }}>
              Nombre del negocio
            </label>
            <input
              value={name}
            ...
            />
            <label style={{ fontSize: 12, color: "rgba(235,235,245,0.5)", textTransform: "uppercase", letterSpacing: 1, display: "block", marginTop: 14 }}>
          ...
          >
            ...
            <div style={{ flex: 1, textAlign: "left" }}>
              ...
              <p style={{ margin: "2px 0 0", fontSize: 13, color: "rgba(235,235,245,0.5)" }}>
                Los clientes lo escanean para vincularse
              </p>
            </div>
            <span style={{ color: "rgba(235,235,245,0.3)", fontSize: 20, transform: showQr ? "rotate(90deg)" : "none", transition: "transform 0.2s" }}>›</span>
          </button>
            ...
            <div style={{ padding: "0 16px 20px", borderTop: "1px solid rgba(84,84,88,0.4)" }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)",
                  color: "#ff9f0a", fontSize: 14, fontWeight: 600, cursor: "pointer",
                  display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
